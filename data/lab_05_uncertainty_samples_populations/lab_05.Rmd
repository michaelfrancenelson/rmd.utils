...
<!-- ## Residuals of our logistic fits -->


<!-- > Recall the functions we used to visually parameterize a logistic function: -->
...
<!-- apply(dat_all, 2, function(x) sum(x > 0) / length(x)) -->


<!-- plot((dat_all$elev), dat_all$AMRO > 0, main = "AMRO", xlab = "Elevation", ylab = "") -->
<!-- plot((dat_all$elev), dat_all$SWTH > 0, main = "AMRO", xlab = "Elevation", ylab = "") -->
<!-- plot((dat_all$elev), dat_all$VATH > 0, main = "VATH", xlab = "Elevation", ylab = "") -->



<!-- resids = (logistic_midpoint_slope(dat_all$elev, 300, -0.002)) -->
<!-- sum(logistic_midpoint_slope(dat_all$elev, 300, -0.002)) -->
<!-- sum(logistic_midpoint_slope(dat_all$elev, 100, -0.02)) -->
<!-- sum(resids) -->
<!-- curve(logistic_midpoint_slope(x, 100, -0.012), add = TRUE) -->

<!-- # hist(logistic_midpoint_slope(dat_all$elev, 400, -0.002)) -->
